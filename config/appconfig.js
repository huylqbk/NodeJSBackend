...
module.exports = {
	app: {
		...
		appName: process.env.APP_NAME || 'huylq',
	...
	db: {
		...
		username: process.env.DB_USER || 'password',
		host: process.env.DB_HOST || '127.0.0.1',
		dialect: 'postgres',
		logging: true,
	},
	winiston: {
		logpath: '/huylqLogs/logs/',
	},
	auth: {
	...
	sendgrid: {
		...
		from_email: process.env.FROM_EMAIL || 'nonreply.huylqbk@gmail.com',
	},
